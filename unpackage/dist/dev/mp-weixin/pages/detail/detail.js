...
/* harmony import */ var _detail_vue_vue_type_template_id_3e159eb4___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./detail.vue?vue&type=template&id=3e159eb4& */ 71);
...
/* harmony import */ var _detail_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./detail.vue?vue&type=style&index=0&lang=scss& */ 75);
...

{
  ...
  methods: {
    init: function init(number) {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var searchRes, params;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (!(
                number == 'self')) {_context.next = 11;break;}_context.next = 3;return (

                  _this.$api.showLoading());case 3:_context.next = 5;return (
                  _this.$api.getData(_this.$api.webapi.memberInfo));case 5:searchRes = _context.sent;_context.next = 8;return (
                  _this.$api.hideLoading());case 8: // 等待请求数据成功后，隐藏loading
                if (searchRes.resultCode == 0) {
                  _this.detail = searchRes.data;
                  _this.dataok = true;
                } else {
                  _this.isEmpty = 1;
                ...
                params = {
                  number: number };_context.next = 14;return (

                  _this.$api.showLoading());case 14:_context.next = 16;return (
                  _this.$api.getData(_this.$api.webapi.memberInfoNum, params));case 16:searchRes = _context.sent;_context.next = 19;return (
                  _this.$api.hideLoading());case 19: // 等待请求数据成功后，隐藏loading
                if (searchRes.resultCode == 0) {
                  _this.detail = searchRes.data;
                  _this.dataok = true;
                } else {
